...
def GetActiveAreas(first,last,band,data):
    ...
    for string in columns:
        b_areas.append(broadmannmapping[string.split('_')[0]])
        columns_stripped.append(string.split('_')[0])
        bmap.append(brainmap[string.split('_')[0]])
    ...
    for sensor in columns:
        if brainmap[sensor.split('_')[0]] == 'Prefrontal Cortex':
            ...
            if areamark[5]== False:
                ...
                areamark[5]= True          
        elif brainmap[sensor.split('_')[0]] == 'Primary Sensory Cortex':
            if areamark[6]== False:
                areas.append('Primary Sensory Cortex')
