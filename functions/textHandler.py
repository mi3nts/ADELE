...
# textfile = "aaTextTester.txt"
# with open(textfile, 'r') as file:
#     extractedText = file.read()
# font = "Times-Roman"
# fontSize = 12
# textRect = fitz.Rect(250, 650, 585, 815)
# textCapacity = calculateTextCapacity(textRect)
#
# doc = fitz.open()
# generatedPage = doc.newPage()
# lines = createTextbox(textfile, textRect, generatedPage)
#
# # textboxShape = generatedPage.new_shape()
# # textboxShape.draw_rect(textRect)
# # textboxShape.finish(color=getColor("dodgerblue4"), fill_opacity=1, closePath=False)
# # textboxShape.commit()
# # text_Location = fitz.Rect(252, 650, 583, 815)
# # generatedPage.insertTextbox(text_Location, lines, fontsize=fontSize, fontname=font, align=0)
# doc.save("aTextTest.pdf")
